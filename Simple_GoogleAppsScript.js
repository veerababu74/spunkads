...
// 
// SETUP INSTRUCTIONS:
// 1. Create a Google Sheet named "manychat" with sheets "source" and "total_report"
...
const DETAILED_SHEET_NAME = "source";   // For detailed campaign data
const SUMMARY_SHEET_NAME = "total_report";   // For summary data
